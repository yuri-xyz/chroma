...
mod tests {
    ...
    fn test_get_preset_valid_indices() {
        for i in 0..25 {
            ...
            assert!(preset.frequency > 0.0, "Preset {} should have positive frequency", i);
        }
    }
    ...
    fn test_get_preset_wraparound() {
        ...
        assert_eq!(preset_0.frequency, preset_25.frequency, "Preset 25 should wrap to preset 0");
        assert_eq!(preset_0.frequency, preset_50.frequency, "Preset 50 should wrap to preset 0");
    }

    #[test]
    fn test_get_random_preset() {
        let preset = get_random_preset();
        assert!(preset.frequency > 0.0, "Random preset should have positive frequency");
    }
}
